...
def main():
    ...
    while True:       
        ...
        #set up platforms
            if (charPos[0]+40) >= 300 and charPos[1] <= 150:
                groundLevel = 150
            elif charPos[0] < 115 and charPos[1] <= 249:
                groundLevel = 249
            elif charPos[0] < 130 and charPos[1] <= 299:
                groundLevel = 299
            elif charPos[0]+40 > 170 and charPos[0] < 200 and charPos[1] <= 149:
                groundLevel = 149
            else:
                groundLevel = 389
            if (groundLevel == 389 and charPos[1] < 215 and (charPos[0]+40) >= 300 and keyDown[0] == True) or (charPos[0]+4 <= 115 and charPos[0]+4 >= 111 and charPos[1]+51 >= 300 and keyDown[1] == True):
                charSpeed[0] = 0
            else:
                charSpeed[0] = 4
        ...
        pygame.draw.rect(mainSurface, (0,0,0), (170,200,30,15))
